  ...
  return (
    <header className="sticky top-0 z-40 border-b border-neutral-900 bg-stone-50/95 backdrop-blur-sm">
      <nav className="mx-auto flex w-full max-w-[1400px] items-center justify-between px-4 py-4 md:px-6">
        <Link to="/" className="flex items-end gap-1 font-mono text-[2rem] leading-none text-neutral-950">
          <span>Kode</span>
          <span className="text-accent">Zilla</span>
          <span className="text-base normal-case tracking-normal text-neutral-500">.io</span>
        </Link>
